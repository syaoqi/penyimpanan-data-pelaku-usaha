...
<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
	...
	<li class="nav-item">
        <a class=" btn btn-warning " href="sumbawatampil.php">Kembali</a>
      </li>
    </ul>
  </div>
</nav>
    ...
    <h4> <b>UBAH DATA</b></h4>
      <div class="col-sm-6">
        ...
        $sql = $koneksi->query("SELECT * FROM sumbawa WHERE nomor=".$_GET['nomor']);
        //konversi data yang terdapat di dalam variabel $sql menjadi bentuk array
        $s = mysqli_fetch_array($sql);
        // var_dump($s)
        ?>
        <form action="sumbawapedit.php" method="POST">
        <div class="row">
            <div class="col-sm-6">
              <!-- <label>ID</label> -->
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <input type="text" name="unit" autofocus class="form-control" value="<?php echo $s['unit']?>">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
            <input type="text" name="tahun" class="form-control" value="<?php echo $s['tahun']?>">
            </div>
          </div>
