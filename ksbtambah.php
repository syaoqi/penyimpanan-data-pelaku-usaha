...
<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  ...
  <a class="navbar-brand" href="#"><b>PELAKU USAHA SUMBAWA KSB</b></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
	...
	<li class="nav-item">
        <a class=" btn btn-warning " href="ksbtampil.php">Kembali</a>
      </li>
    </ul>
  </div>
</nav>
<div class="container">
    ...
    <h4> <b>Tambah Data Pelaku Usaha</b></h4>
      <div  class="col-sm-6">
        <p><form action="ksbptambah.php" method="POST"></p>
