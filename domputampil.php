...
$tampil = query("SELECT * FROM dompu");

if (isset($_POST["cari"]) ){
	$tampil = cari3($_POST["keyword"]);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  ...
  <a class="navbar-brand" href="#"><b>PELAKU USAHA DOMPU</b></a>
...
<div class="table-responsive">
	...
	<a  class="button btn btn-primary" href="domputambah.php">Tambah</a>
<a  class="button btn btn-success" href="domputampil.php">Tampilkan Semua Data</a>
...
<?php foreach ($tampil as $row) : ?>
			...
			<td><?= $i ?></td>
				...
				<td>
					<a href="dompuedit.php?nomor=<?php echo $row['nomor'];?>" type="button" class="btn btn-warning btn-sm" style= "margin-bottom:5px"  >UBAH</a>
					<a href="dompuhapus.php?nomor=<?php echo $row['nomor'];?>" type="button" class="btn btn-danger btn-sm">HAPUS</a>
				</td>
