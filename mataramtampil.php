...
$tampil = query("SELECT * FROM mataram");

if (isset($_POST["cari"]) ){
	$tampil = cari9($_POST["keyword"]);
}
...
<div class="table-responsive">
	...
	<a  class="button btn btn-primary" href="tambahmataram.php">Tambah</a>
<a  class="button btn btn-success" href="mataramtampil.php">Tampilkan Semua Data</a>
...
<?php foreach ($tampil as $row) : ?>
			...
			<td><?= $i ?></td>
				...
				<td>
					<a href="editmataram.php?nomor=<?php echo $row['nomor'];?>" type="button" class="btn btn-warning btn-sm" style= "margin-bottom:5px"  >UBAH</a>
					<a href="hapusmataram.php?nomor=<?php echo $row['nomor'];?>" type="button" class="btn btn-danger btn-sm">HAPUS</a>
				</td>
