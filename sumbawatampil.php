...
$tampil = query("SELECT * FROM sumbawa");

if (isset($_POST["cari"]) ){
	$tampil = cari4($_POST["keyword"]);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  ...
  <a class="navbar-brand" href="#"><b>PELAKU USAHA SUMBAWA</b></a>
...
<div class="table-responsive">
	...
	<a  class="button btn btn-primary" href="sumbawatambah.php">Tambah</a>
<a  class="button btn btn-success" href="sumbawatampil.php">Tampilkan Semua Data</a>
...
<?php foreach ($tampil as $row) : ?>
			...
			<td><?= $i ?></td>
				...
				<td>
					<a href="sumbawaedit.php?nomor=<?php echo $row['nomor'];?>" type="button" class="btn btn-warning btn-sm" style= "margin-bottom:5px"  >UBAH</a>
					<a href="sumbawahapus.php?nomor=<?php echo $row['nomor'];?>" type="button" class="btn btn-danger btn-sm">HAPUS</a>
				</td>
